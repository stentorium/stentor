...
[Stentor API Reference](../../../README.md) / [stentor-models/src](../README.md) / AddressIntentRequest

# Interface: AddressIntentRequest

Defined in: [packages/stentor-models/src/Request/AddressIntentRequest.ts:41](https://github.com/stentorium/stentor/blob/c0410dcd7b880b4f8e849bc9e18a802c802d0a12/packages/stentor-models/src/Request/AddressIntentRequest.ts#L41)
...
Defined in: [packages/stentor-models/src/Request/AddressIntentRequest.ts:45](https://github.com/stentorium/stentor/blob/c0410dcd7b880b4f8e849bc9e18a802c802d0a12/packages/stentor-models/src/Request/AddressIntentRequest.ts#L45)

An intent that can parse an address query

#### Overrides

[`IntentRequest`](IntentRequest.md).[`intentId`](IntentRequest.md#intentid)

***

### slots

> **slots**: [`AddressIntentRequestSlotMap`](AddressIntentRequestSlotMap.md)

Defined in: [packages/stentor-models/src/Request/AddressIntentRequest.ts:49](https://github.com/stentorium/stentor/blob/c0410dcd7b880b4f8e849bc9e18a802c802d0a12/packages/stentor-models/src/Request/AddressIntentRequest.ts#L49)

The slots

#### Overrides

[`IntentRequest`](IntentRequest.md).[`slots`](IntentRequest.md#slots)
...
[`IntentRequest`](IntentRequest.md).[`type`](IntentRequest.md#type)
...
[`IntentRequest`](IntentRequest.md).[`sessionId`](IntentRequest.md#sessionid)
...
[`IntentRequest`](IntentRequest.md).[`matchConfidence`](IntentRequest.md#matchconfidence)
...
[`IntentRequest`](IntentRequest.md).[`activeContexts`](IntentRequest.md#activecontexts)
...
[`IntentRequest`](IntentRequest.md).[`isBargeIn`](IntentRequest.md#isbargein)
...
[`IntentRequest`](IntentRequest.md).[`canFulfill`](IntentRequest.md#canfulfill)
...
[`IntentRequest`](IntentRequest.md).[`data`](IntentRequest.md#data)
...
[`IntentRequest`](IntentRequest.md).[`knowledgeAnswer`](IntentRequest.md#knowledgeanswer)
...
[`IntentRequest`](IntentRequest.md).[`knowledgeBaseResult`](IntentRequest.md#knowledgebaseresult)
...
[`IntentRequest`](IntentRequest.md).[`attachments`](IntentRequest.md#attachments)
...
[`IntentRequest`](IntentRequest.md).[`overrideKey`](IntentRequest.md#overridekey)
...
[`IntentRequest`](IntentRequest.md).[`createdTime`](IntentRequest.md#createdtime)
...
[`IntentRequest`](IntentRequest.md).[`userId`](IntentRequest.md#userid)
...
[`IntentRequest`](IntentRequest.md).[`deviceId`](IntentRequest.md#deviceid)
...
[`IntentRequest`](IntentRequest.md).[`requestId`](IntentRequest.md#requestid)
...
[`IntentRequest`](IntentRequest.md).[`anonymous`](IntentRequest.md#anonymous)
...
[`IntentRequest`](IntentRequest.md).[`isNewSession`](IntentRequest.md#isnewsession)
...
[`IntentRequest`](IntentRequest.md).[`accessToken`](IntentRequest.md#accesstoken)
...
[`IntentRequest`](IntentRequest.md).[`apiAccess`](IntentRequest.md#apiaccess)
...
[`IntentRequest`](IntentRequest.md).[`rawQuery`](IntentRequest.md#rawquery)
...
[`IntentRequest`](IntentRequest.md).[`platform`](IntentRequest.md#platform)
...
[`IntentRequest`](IntentRequest.md).[`channel`](IntentRequest.md#channel)
...
[`IntentRequest`](IntentRequest.md).[`device`](IntentRequest.md#device)
...
[`IntentRequest`](IntentRequest.md).[`locale`](IntentRequest.md#locale)
...
[`IntentRequest`](IntentRequest.md).[`isHealthCheck`](IntentRequest.md#ishealthcheck)
...
[`IntentRequest`](IntentRequest.md).[`attributes`](IntentRequest.md#attributes)
...
[`IntentRequest`](IntentRequest.md).[`sentimentAnalysis`](IntentRequest.md#sentimentanalysis)
