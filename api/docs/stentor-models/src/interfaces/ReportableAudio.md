...
[Stentor API Reference](../../../README.md) / [stentor-models/src](../README.md) / ReportableAudio

# Interface: ReportableAudio

Defined in: [packages/stentor-models/src/Media/ReportableAudio.ts:13](https://github.com/stentorium/stentor/blob/c0410dcd7b880b4f8e849bc9e18a802c802d0a12/packages/stentor-models/src/Media/ReportableAudio.ts#L13)

Audio that is reportable

## Extends

- [`Audio`](Audio.md).[`Reportable`](Reportable.md)

## Extended by

- [`SocialRadioTrack`](SocialRadioTrack.md)
