...
[Stentor API Reference](../../../README.md) / [stentor/src](../README.md) / Intent

# Interface: Intent

Defined in: packages/stentor-models/lib/Intent/Intent.d.ts:19

Intents represent the request of a user.

## Extends

- `Localizable`\<`LocaleSpecificIntent`\>
