 ...
 */
export declare type ScheduledResponse<T = string | ResponseOutput> = Schedulable<SimpleResponse<T>>;
/**
 ...
 */
export declare type JSONDependentResponse<T = string | ResponseOutput> = JSONDependable<SimpleResponse<T>>;
/**
 * A response is a possible response back to a user; it includes a prompt, reprompt, and visual
 * assets.
 */
export declare type Response<T = string | ResponseOutput> = JSONDependentResponse<T> | LastActiveResponse<T> | RequestDependentResponse<T> | ScheduledResponse<T> | SimpleResponse<T> | SlotDependentResponse<T> | StorageDependentResponse<T> | SystemDependentResponse<T>;
