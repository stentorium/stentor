...
export var GetDurationGroupBy;
(function (GetDurationGroupBy) {
    GetDurationGroupBy[GetDurationGroupBy["Largest"] = 0] = "Largest";
    GetDurationGroupBy[GetDurationGroupBy["Smallest"] = 1] = "Smallest";
})(GetDurationGroupBy || (GetDurationGroupBy = {}));
/**
 ...
 */
export function getDurationFrom(iso8601Duration, groupBy = GetDurationGroupBy.Largest) {
    let duration;
    if (isISO8601Duration(iso8601Duration)) {
        ...
        Object.keys(durationsMap).forEach((durationString) => {
            ...
            const potentialFormat = durationString;
...
//# sourceMappingURL=getDurationFrom.js.map