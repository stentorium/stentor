 ...
 */
function getNearestDayOfWeek(from, targetDay) {
 ...
 */
function getLastDayOfWeek(from, targetDay) {
    const currentDay = from.getDay();
    const result = new Date(from.getFullYear(), from.getMonth(), from.getDate());
 ...
 */
function getRelativeDate(from, amount, unit) {
    const result = new Date(from.getFullYear(), from.getMonth(), from.getDate());
    switch (unit) {
        case 'day':
...
//# sourceMappingURL=natural-date-parser.js.map