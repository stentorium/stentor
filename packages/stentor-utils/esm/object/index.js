 ...
 *
 */
export function removeItems(obj, attrs) {
    if (!obj) {
        return obj;
    }
    ...
    const returnObj = objIsArray ? obj.slice() : Object.assign({}, obj);
    const deleteItem = (key) => {
        if (objIsArray) {
            returnObj.splice(key, 1);
        }
        else {
 ...
 */
export function subset(obj, attrs) {
    if (!obj) {
        return obj;
    }
    if (!attrs || attrs.length === 0) {
 ...
 */
export function objHasAttrs(obj) {
    const testObj = obj || {};
 ...
 */
export function throwIfDoesContain(obj, bannedAttrs, onError = defaultValidationErrorHandler) {
 ...
 */
export function throwIfDoesNotContain(obj, requiredAttrs, undefinedPermitted, onError = defaultValidationErrorHandler) {
    if (!obj) {
 ...
 */
export function throwIfContainsExtra(obj, restrictAttrs, undefinedPermitted, onError = defaultValidationErrorHandler) {
    if (!obj) {
        if (undefinedPermitted) {
            return;
        }
